    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function norm(vec) {
          ...
          try {
            for (
              var vec_1 = __values(vec), vec_1_1 = vec_1.next();
              !vec_1_1.done;
              vec_1_1 = vec_1.next()
            ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.smallestFlagged =
          exports.deheapSort =
          exports.buildCandidates =
          exports.uncheckedHeapPush =
          exports.heapPush =
          exports.rejectionSample =
          exports.makeHeap =
            void 0;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.getCSR =
          exports.normalize =
          exports.eliminateZeros =
          exports.multiplyScalar =
          exports.maximum =
          exports.subtract =
          exports.add =
          exports.pairwiseMultiply =
          exports.identity =
          exports.transpose =
          exports.SparseMatrix =
            void 0;
        var utils = __importStar(__webpack_require__(0));
        ...
        function normalize(m, normType) {
          ...
          try {
            for (
              var _b = __values(colsByRow.keys()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var row = _c.value;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.searchFlatTree =
          exports.makeLeafArray =
          exports.makeForest =
          exports.FlatTree =
            void 0;
        var utils = __importStar(__webpack_require__(0));
        ...
        function makeEuclideanTree(data, indices, leafSize, q, random) {
          ...
          if (indices.length > leafSize) {
            var splitResults = euclideanRandomProjectionSplit(
              data,
              indices,
              random
            );
            ...
            var leftChild = makeEuclideanTree(
              data,
              indicesLeft,
              leafSize,
              q + 1,
            ...
            var rightChild = makeEuclideanTree(
              data,
              indicesRight,
              leafSize,
              q + 1,
        ...
        function recursiveFlatten(
          ...
          if (tree.isLeaf) {
            ...
            (_a = indices[leafNum]).splice.apply(
              _a,
              __spread([0, tree.indices.length], tree.indices)
            );
            leafNum += 1;
        ...
        function makeLeafArray(rpForest) {
          ...
          if (rpForest.length > 0) {
            ...
            try {
              for (
                var rpForest_1 = __values(rpForest),
                  rpForest_1_1 = rpForest_1.next();
                !rpForest_1_1.done;
                rpForest_1_1 = rpForest_1.next()
              ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.initTransform =
          exports.resetLocalConnectivity =
          exports.fastIntersection =
          exports.findABParams =
          exports.cosine =
          exports.euclidean =
          exports.UMAP =
            void 0;
        ...
        var UMAP = (function () {
          ...
          UMAP.prototype.setSupervisedProjection = function (Y, params) {
            ...
            this.targetNNeighbors =
              params.targetNNeighbors || this.targetNNeighbors;
          };
          UMAP.prototype.setPrecomputedKNN = function (
            knnIndices,
            knnDistances
          ) {
          ...
          UMAP.prototype.initializeFit = function (X) {
            ...
            var _a = this.initializeSimplicialSetEmbedding(),
              head = _a.head,
              tail = _a.tail,
              epochsPerSample = _a.epochsPerSample;
          ...
          UMAP.prototype.makeSearchFns = function () {
            var _a = nnDescent.makeInitializations(this.distanceFn),
              initFromTree = _a.initFromTree,
              initFromRandom = _a.initFromRandom;
          ...
          UMAP.prototype.transform = function (toTransform) {
            ...
            var nNeighbors = Math.floor(
              this.nNeighbors * this.transformQueueSize
            );
            nNeighbors = Math.min(rawData.length, nNeighbors);
            var init = nnDescent.initializeSearch(
              this.rpForest,
              rawData,
              toTransform,
              nNeighbors,
            ...
            var _a = heap.deheapSort(result),
              indices = _a.indices,
              distances = _a.weights;
            ...
            var adjustedLocalConnectivity = Math.max(
              0,
              this.localConnectivity - 1
            );
            var _b = this.smoothKNNDistance(
                distances,
                this.nNeighbors,
              ...
              sigmas = _b.sigmas,
              rhos = _b.rhos;
            var _c = this.computeMembershipStrengths(
                indices,
                distances,
                sigmas,
                rhos
            ...
            var eIndices = utils.reshape2d(
              csrMatrix.indices,
              nPoints,
              this.nNeighbors
            );
            var eWeights = utils.reshape2d(
              csrMatrix.values,
              nPoints,
              this.nNeighbors
            );
            ...
            var epochsPerSample = this.makeEpochsPerSample(
              graph.getValues(),
              nEpochs
            );
          ...
          UMAP.prototype.nearestNeighbors = function (X) {
            var _a = this,
              distanceFn = _a.distanceFn,
              nNeighbors = _a.nNeighbors;
            var log2 = function (n) {
              return Math.log(n) / Math.log(2);
            };
            var metricNNDescent = nnDescent.makeNNDescent(
              distanceFn,
              this.random
            );
            ...
            var _b = metricNNDescent(X, leafArray, nNeighbors, nIters),
              indices = _b.indices,
              weights = _b.weights;
            return { knnIndices: indices, knnDistances: weights };
          };
          UMAP.prototype.fuzzySimplicialSet = function (
            X,
            nNeighbors,
            setOpMixRatio
          ) {
            ...
            var _a = this,
              _b = _a.knnIndices,
              knnIndices = _b === void 0 ? [] : _b,
              _c = _a.knnDistances,
              knnDistances = _c === void 0 ? [] : _c,
              localConnectivity = _a.localConnectivity;
            var _d = this.smoothKNNDistance(
                knnDistances,
                nNeighbors,
                localConnectivity
              ),
              sigmas = _d.sigmas,
              rhos = _d.rhos;
            var _e = this.computeMembershipStrengths(
                knnIndices,
                knnDistances,
                sigmas,
                rhos
            ...
            var a = matrix.subtract(
              matrix.add(sparseMatrix, transpose),
              prodMatrix
            );
          ...
          UMAP.prototype.categoricalSimplicialSetIntersection = function (
            simplicialSet,
            target,
            farDist,
            unknownDist
            ...
            var intersection = fastIntersection(
              simplicialSet,
              target,
              unknownDist,
              farDist
          ...
          UMAP.prototype.smoothKNNDistance = function (
            distances,
            k,
            localConnectivity,
            nIter,
              ...
              if (nonZeroDists.length >= localConnectivity) {
                ...
                if (index > 0) {
                  ...
                  if (interpolation > SMOOTH_K_TOLERANCE) {
                    rho[i] +=
                      interpolation *
                      (nonZeroDists[index] - nonZeroDists[index - 1]);
                  }
                } else {
          ...
          UMAP.prototype.computeMembershipStrengths = function (
            knnIndices,
            knnDistances,
            sigmas,
            rhos
          ...
          UMAP.prototype.prepareForOptimizationLoop = function () {
            var _a = this,
              repulsionStrength = _a.repulsionStrength,
              learningRate = _a.learningRate,
              negativeSampleRate = _a.negativeSampleRate;
            var _b = this.optimizationState,
              epochsPerSample = _b.epochsPerSample,
              headEmbedding = _b.headEmbedding,
              tailEmbedding = _b.tailEmbedding;
          ...
          UMAP.prototype.initializeOptimization = function () {
            ...
            var _a = this.optimizationState,
              head = _a.head,
              tail = _a.tail,
              epochsPerSample = _a.epochsPerSample;
            var nEpochs = this.getNEpochs();
            var nVertices = this.graph.nCols;
            var _b = findABParams(this.spread, this.minDist),
              a = _b.a,
              b = _b.b;
            this.assignOptimizationStateParameters({
            ...
            for (var i = 0; i < epochsPerSample.length; i++) {
              ...
              for (var p = 0; p < nNegSamples; p++) {
                ...
                for (var d = 0; d < dim; d++) {
                  ...
                  if (gradCoeff_1 > 0.0) {
                    gradD = clip(
                      gradCoeff_1 * (current[d] - other_1[d]),
                      clipValue
                    );
                  }
                  current[d] += gradD * alpha;
              ...
              epochOfNextNegativeSample[i] +=
                nNegSamples * epochsPerNegativeSample[i];
            }
              ...
              var step = function () {
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_b) {
                    try {
                      (_a = this.optimizationState),
                        (nEpochs = _a.nEpochs),
                        (currentEpoch = _a.currentEpoch);
        ...
        function findABParams(spread, minDist) {
          ...
          var parameterValues = ml_levenberg_marquardt_1.default(
            data,
            curve,
            options
          ).parameterValues;
          var _a = __read(parameterValues, 2),
            a = _a[0],
            b = _a[1];
          return { a: a, b: b };
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.initializeSearch =
          exports.makeInitializedNNSearch =
          exports.makeInitializations =
          exports.makeNNDescent =
            void 0;
        var heap = __importStar(__webpack_require__(1));
        var matrix = __importStar(__webpack_require__(2));
        var tree = __importStar(__webpack_require__(3));
        ...
        function makeNNDescent(distanceFn, random) {
          return function nNDescent(
            ...
            for (var i = 0; i < data.length; i++) {
              var indices = heap.rejectionSample(
                nNeighbors,
                data.length,
                random
              );
            ...
            for (var n = 0; n < nIters; n++) {
              var candidateNeighbors = heap.buildCandidates(
                currentGraph,
                nVertices,
                nNeighbors,
                maxCandidates,
        ...
        function makeInitializations(distanceFn) {
          function initFromRandom(
            ...
            for (var i = 0; i < queryPoints.length; i++) {
              var indices = utils.rejectionSample(
                nNeighbors,
                data.length,
                random
              );
          ...
          return function nnSearchFn(data, graph, initialization, queryPoints) {
            ...
            for (var i = 0; i < queryPoints.length; i++) {
              ...
              while (true) {
                ...
                var candidates = indices.slice(
                  indptr[vertex],
                  indptr[vertex + 1]
                );
                try {
                  for (
                    var candidates_1 = ((e_1 = void 0), __values(candidates)),
        ...
        function initializeSearch(
          ...
          if (forest) {
            try {
              for (
                var forest_1 = __values(forest), forest_1_1 = forest_1.next();
                !forest_1_1.done;
                forest_1_1 = forest_1.next()
              ) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        const node_modules_is_any_array_src_toString =
        ...
        function lib_es6_max(input) {
          ...
          var _options$fromIndex = options.fromIndex,
            ...
            toIndex =
              _options$toIndex === void 0 ? input.length : _options$toIndex;
        ...
        const ml_array_min_node_modules_is_any_array_src_toString =
          Object.prototype.toString;

        function node_modules_is_any_array_src_isAnyArray(object) {
          return ml_array_min_node_modules_is_any_array_src_toString
            .call(object)
            .endsWith('Array]');
        }
...
${indent}columns: ${matrix.columns}
        ...
        function installMathOperations(AbstractMatrix, Matrix) {
          ...
          AbstractMatrix.prototype.signPropagatingRightShift =
          ...
          AbstractMatrix.prototype.signPropagatingRightShiftS =
            function signPropagatingRightShiftS(value) {
              for (let i = 0; i < this.rows; i++) {
                for (let j = 0; j < this.columns; j++) {
                  this.set(i, j, this.get(i, j) >> value);
                }
          ...
          AbstractMatrix.prototype.signPropagatingRightShiftM =
            function signPropagatingRightShiftM(matrix) {
              matrix = Matrix.checkMatrix(matrix);
              if (
          ...
          AbstractMatrix.prototype.zeroFillRightShift =
            AbstractMatrix.prototype.rightShift;
          AbstractMatrix.prototype.zeroFillRightShiftS =
            AbstractMatrix.prototype.rightShiftS;
          AbstractMatrix.prototype.zeroFillRightShiftM =
            AbstractMatrix.prototype.rightShiftM;
        ...
        class matrix_AbstractMatrix {
            ...
            for (let i = 0; i < rows; i++) {
              for (let j = 0; j < columns; j++) {
                result.set(
                  i,
                  j,
                  Math.min(matrix1.get(i, j), matrix2.get(i, j))
                );
              }
            }
            return result;
            ...
            for (let i = 0; i < rows; i++) {
              for (let j = 0; j < columns; j++) {
                result.set(
                  i,
                  j,
                  Math.max(matrix1.get(i, j), matrix2.get(i, j))
                );
              }
            }
            return result;
          ...
          static checkMatrix(value) {
            return matrix_AbstractMatrix.isMatrix(value)
              ? value
              : new matrix_Matrix(value);
          }
                ...
                for (let i = h + 1; i < result.rows; i++) {
                  ...
                  for (let j = k + 1; j < result.columns; j++) {
                    result.set(
                      i,
                      j,
                      result.get(i, j) - result.get(h, j) * factor
                    );
                  }
                }
                h++;
          ...
          dot(vector2) {
            if (matrix_AbstractMatrix.isMatrix(vector2))
          ...
          mmulStrassen(y) {
            ...
            function blockMult(a, b, rows, cols) {
              ...
              let m2 = blockMult(
                matrix_AbstractMatrix.add(a21, a22),
                b11,
                halfRows,
                halfCols
              );
              let m3 = blockMult(
                a11,
                matrix_AbstractMatrix.sub(b12, b22),
                halfRows,
                halfCols
              );
              let m4 = blockMult(
                a22,
                matrix_AbstractMatrix.sub(b21, b11),
                halfRows,
                halfCols
              );
              let m5 = blockMult(
                matrix_AbstractMatrix.add(a11, a12),
                b22,
                halfRows,
                halfCols
              );
              ...
              let resultat = matrix_AbstractMatrix.zeros(
                2 * c11.rows,
                2 * c11.columns
              );
            ...
            for (let i = 0; i < indices.length; i++) {
              for (let j = startRow; j <= endRow; j++) {
                if (indices[i] < 0 || indices[i] >= this.columns) {
                  throw new RangeError(
                    `Column index out of range: ${indices[i]}`
                  );
                }
        ...
        matrix_AbstractMatrix.prototype.diagonal =
          matrix_AbstractMatrix.prototype.diag;
        matrix_AbstractMatrix.identity = matrix_AbstractMatrix.eye;
        matrix_AbstractMatrix.prototype.negate =
          matrix_AbstractMatrix.prototype.neg;
        ...
        function solve(leftHandSide, rightHandSide, useSVD = false) {
          leftHandSide =
            WrapperMatrix2D_WrapperMatrix2D.checkMatrix(leftHandSide);
          rightHandSide =
            WrapperMatrix2D_WrapperMatrix2D.checkMatrix(rightHandSide);
          if (useSVD) {
            return new svd_SingularValueDecomposition(leftHandSide).solve(
              rightHandSide
            );
          } else {
        ...
        function gradientFunction(
          ...
          for (let param = 0; param < n; param++) {
            ...
            for (let point = 0; point < m; point++) {
              ans[param][point] =
                evaluatedData[point] - funcParam(data.x[point]);
            }
          }
